...
def inject_custom_theme():
    ...
    st.markdown(
        ...
        /* Header toolbar atas & garis dekorasi tipis dibuat transparan,
           supaya background/gradient halaman menyatu sampai ke ujung atas
           (tidak ada bar putih yang memutus tampilan). */
...
def main():
    ...
    with col2:
        st.title("Aplikasi Persetujuan Konten")
